...
export default function Home() {
  const perks=[
    ...
    },
    {
      name:"For the planet",
      icon: Leaf,
      description:"We've pledged 1% of sales for the preservation and restoration of the nature",
    },
  ]
  return (
    <>
    <MaxwidthWrapper>
      <div className="mx-auto text-center py-20 flex flex-col items-center max-w-3xl">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 md:text-6xl">Your marketplace for high quality <span className="text-blue-600">
          digital assets
        </span>
        </h1>
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">Welcome to DigitalHippo. Every asset on our platform is 
